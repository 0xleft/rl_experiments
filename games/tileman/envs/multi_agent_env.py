...
class TileServerLoadBalancer:
    def __init__(self, max_players_per_server=4, grid_size=40, vision_range=10, host='localhost', port=32544):
        self.host = host
        self.port = port
...
class TileServer:
    ...
    @staticmethod
    def create_server(grid_size=40, vision_range=10, host='0.0.0.0', port=9909):
